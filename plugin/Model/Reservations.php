...
class Reservations extends Model
{
    ...
    */
    ...
    {
        return $this->hasMany(ReservationItems::class, 'reservation_id', 'reservation_id');
    }

    public function ReservationItemMeta()
    {
        return $this->hasMany(ReservationItemMeta::class, 'reservation_id', 'reservation_id');
    }
    ...
    public function getReservationsForDashboard()
    {
        $reservations = $this->select('reservation_id', 'check_in', 'check_out', 'reservation_status')->get()->toArray();
        $reservationMeta = new ReservationItemMeta;
        $dashboardData = [];
        foreach ($reservations as $reservation) {
            $reservationDetails = $reservationMeta->getReservationMeta($reservation['reservation_id']);
            array_push($dashboardData, $reservationDetails);
        }
